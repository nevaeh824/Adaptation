...
- For each source pair, `G` and `X` are replaced by within-country first differences: `source_it - source_i,t-1`.
...
| G source           |               X source | Table 2$$G$$ | Full
$$
G\times B
$$
...
$$
 ...
 | Mean theta | Debt baseline$$G$$ | Debt continuous
$$
G\times\theta
$$
...
| readiness100       | vulnerability_delta100 |         -2.854 |           -1.384 |          395.039 |      1.396 |                0.056 |                          -0.052 |     15.662 |        0.064 |    -8.756*** |   0.000 |       [report](result/gx_delta_grid/readiness100__vulnerability_delta100/report.md) |
| readiness100       |               capacity |         -2.868 |           -2.180 |          708.058 |      0.892 |                0.056 |                        -0.080** |     20.427 |        0.064 |    -6.889*** |   0.001 |                     [report](result/gx_delta_grid/readiness100__capacity/report.md) |
...
| EcoReadiness100    |               capacity |       -1.489** |            0.685 |           78.408 |      0.592 |                0.014 |                       -0.212*** |      1.213 |        0.027 |      -1.115* |   0.052 |                  [report](result/gx_delta_grid/EcoReadiness100__capacity/report.md) |
...
| governance100      | vulnerability_delta100 |          3.460 |          -21.992 |         -286.707 |      0.881 |               -0.072 |                           0.009 |     -5.955 |    -3.575*** |       -0.041 |   0.001 |      [report](result/gx_delta_grid/governance100__vulnerability_delta100/report.md) |
...
| governance100      |            sensitivity |          3.428 |          -19.653 |       -1168.817* |      0.750 |               -0.072 |                           0.013 |     61.712 |       -0.064 |   -18.503*** |   0.000 |                 [report](result/gx_delta_grid/governance100__sensitivity/report.md) |
...
| social100          |            sensitivity |          2.109 |            0.301 |           -7.549 |     -1.331 |                0.167 |                           0.245 |     -3.586 |    -4.698*** |        0.216 |   0.000 |                     [report](result/gx_delta_grid/social100__sensitivity/report.md) |
| readiness_delta100 |       vulnerability100 |         -2.807 |            4.853 |          823.363 |      0.465 |                0.011 |                          -0.073 |    -14.758 |     8.971*** |        0.011 |   0.000 |       [report](result/gx_delta_grid/readiness_delta100__vulnerability100/report.md) |
| readiness_delta100 | vulnerability_delta100 |         -2.964 |            5.289 |        -100.784* |      0.767 |                0.011 |                          -0.051 |      4.450 |        0.060 |     -0.719** |   0.013 | [report](result/gx_delta_grid/readiness_delta100__vulnerability_delta100/report.md) |
| readiness_delta100 |               capacity |         -2.801 |            5.103 |        663.084** |     -0.252 |                0.011 |                        -0.055** |     -2.741 |        0.644 |       -0.024 |   0.075 |               [report](result/gx_delta_grid/readiness_delta100__capacity/report.md) |
| readiness_delta100 |            sensitivity |         -2.806 |            6.770 |         -594.151 |      0.082 |                0.011 |                          -0.021 |    -19.213 |     8.965*** |        0.014 |   0.007 |            [report](result/gx_delta_grid/readiness_delta100__sensitivity/report.md) |
