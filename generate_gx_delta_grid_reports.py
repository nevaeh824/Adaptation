...
GRID_DIR = ROOT / "result" / "gx_delta_grid"
SUMMARY_CSV = GRID_DIR / "gx_delta_grid_summary.csv"
SUMMARY_MD = ROOT / "paperB_gx_delta_grid_empirical_report.md"
...
def write_combo_report(combo_dir):
    ...
    lines = [
        f"# Delta G/X Combination Report: `{combo}`",
        "",
        "## 1. Specification",
        "",
        f"- $$G_{{it}} = \\Delta$$ `{g}`.",
