...
\midrule
$$G_{it}\times 1\{\widehat{\theta}^{F}_{it}<\widehat{c}\}$$ & 0.338*** \\
 & (3.568) \\
$$G_{it}\times 1\{\widehat{\theta}^{F}_{it}\geq\widehat{c}\}$$ & 0.006 \\
 & (0.248) \\
Real GDP & 8.195*** \\
 & (5.353) \\
...
CPI inflation & -0.170** \\
 & (-2.051) \\
Overall balance/GDP & -0.482*** \\
 & (-6.028) \\
International reserves & 0.021 \\
 & (1.485) \\
Government effectiveness & -1.937** \\
 & (-2.037) \\
Regulatory quality & 1.555* \\
 & (1.767) \\
...
$$\lambda_L-\lambda_H$$ & 0.332*** \\
 & (3.483) \\
\midrule
RSS-selected cutoff $$\widehat{c}$$ & 0.146 \\
Empirical percentile of $$\widehat{c}$$ & 3.77 \\
RSS at $$\widehat{c}$$ & 1.986 \\
Low-theta observations & 40 \\
High-theta observations & 1,020 \\
Controls & Yes \\
Country FE & Yes \\
Year FE & Yes \\
$$p_L$$ at RSS cutoff & 0.000 \\
$$p_H$$ at RSS cutoff & 0.804 \\
