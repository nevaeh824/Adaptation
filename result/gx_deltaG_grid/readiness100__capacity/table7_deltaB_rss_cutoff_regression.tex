...
\midrule
$$G_{it}\times 1\{\widehat{\theta}^{F}_{it}<\widehat{c}\}$$ & 0.045 \\
 & (0.591) \\
$$G_{it}\times 1\{\widehat{\theta}^{F}_{it}\geq\widehat{c}\}$$ & 64.856*** \\
 & (9.235) \\
Real GDP & 8.415*** \\
 & (5.512) \\
Real GDP growth & -0.330*** \\
 & (-3.658) \\
CPI inflation & -0.145* \\
 & (-1.926) \\
...
International reserves & 0.020 \\
 & (1.446) \\
Government effectiveness & -2.214** \\
 & (-2.347) \\
Regulatory quality & 1.444* \\
 & (1.652) \\
...
$$\lambda_L-\lambda_H$$ & -64.811*** \\
 & (-9.229) \\
\midrule
RSS-selected cutoff $$\widehat{c}$$ & 13.032 \\
Empirical percentile of $$\widehat{c}$$ & 99.91 \\
RSS at $$\widehat{c}$$ & 1.862 \\
Low-theta observations & 1,059 \\
High-theta observations & 1 \\
Controls & Yes \\
Country FE & Yes \\
Year FE & Yes \\
$$p_L$$ at RSS cutoff & 0.554 \\
